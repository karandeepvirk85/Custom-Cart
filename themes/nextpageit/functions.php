...
function themeStyles() {
	...
	wp_enqueue_style('dataTable','jquery/dataTables.bootstrap.min.css');	
...
function themeScripts() {
	...
	wp_enqueue_script('data-able','https://cdn.datatables.net/1.10.15/js/jquery.dataTables.min.js');
